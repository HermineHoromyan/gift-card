...
namespace NverCard.Public.Client.Shared.Navbar
{
    public partial class NavigationBar
    {
        ...
        private bool ShowBasketDropDownMenu { get; set; }
        ...
        {
            //ShowBasketDropDownMenu = false;
            await NavigationService.GoToPage(url);
        }

        public async Task<bool> ShowBasketDropDown()
        {
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            try
            {
                ...
                ShowBasketDropDownMenu = await ShowBasketDropDown();
            }
            ...
            NavigationService.OnChange += (async () =>
            {
                Console.WriteLine("asas");
                Console.WriteLine(NavigationService.IsBasket);
                ShowBasketDropDownMenu = !NavigationService.IsBasket;
                StateHasChanged();
            });
        ...
        {
            //ShowBasketDropDownMenu = true;
            if (firstRender)
            {
                await JSRuntime.InvokeVoidAsync("navbarFixed.init");
            }
        }
